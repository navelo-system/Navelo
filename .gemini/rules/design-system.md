...
## 1. Arquitetura de Pastas (`Navelo/src/components/store`)
...
- **NUNCA** usar componentes fora de `Navelo/src/components/store`.
...
1. **Catalogação Primeiro:** todo novo componente ou variação deve ser implementado e documentado em `Navelo/app/design-system/page.tsx` **antes** de ser usado em qualquer outra parte do sistema.
...
- Componente fora de `Navelo/src/components/store`

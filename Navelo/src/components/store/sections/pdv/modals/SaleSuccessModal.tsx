...
export const SaleSuccessModal: React.FC<SaleSuccessModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={m.successSaleTitle} variant="default">
      <Stack gap={5} align="center" w="full">
        ...
        <Stack gap={1} align="center" w="full">
          <Font variant="h3" text={m.successSaleTitle} align="center" />
        ...
        <Box padding={5} bg="bg-surface-sunken" radius="default" w="full">
          <Stack gap={2.5}>
            <Stack direction="row" justify="between" align="center">
              <Font variant="body-sm-medium" color="muted" text={m.paymentMethodLabel} />
              <Font variant="body-sm-semibold" text={paymentMethod || "Dinheiro"} />
            </Stack>
            <Stack direction="row" justify="between" align="center">
              <Font variant="body-sm-medium" color="muted" text={m.totalAmountLabel} />
              <Font variant="body-bold" color="success" text={formatPrice(total)} />
            </Stack>
            {change > 0 && (
              <Stack direction="row" justify="between" align="center">
                <Font variant="body-sm-medium" color="muted" text={m.changeToReturnLabel} />

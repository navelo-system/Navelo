...
import { QrCodeSvg } from "../../base/QrCodeSvg"
    ...
    <Stack gap={5} w="full">
      ...
      >
        <Stack gap={5} w="full">
          ...
          {enabled && (
            <>
              {/* Banner de Aviso (Aviso Habilitado) */}
              <Alert
                variant="warning"
                title="WhatsApp habilitado"
                description="Siga as instruções abaixo para conectar seu WhatsApp e habilitar o envio automático de mensagens."
              />
